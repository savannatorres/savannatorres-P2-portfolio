...
```{r}
p5 <- mydata %>% ggplot(aes(x = Marital, y = Height, fill = Marital)) +
  geom_boxplot() +
  labs(x = "Marital", y = "Height") +
  theme_minimal()
plot(p5)
figure_file <- here("starter-analysis-exercise", "results", "figures", "marital-height-boxplot.png")
...
p6 <- mydata %>% ggplot(aes(x = Weight, y = Age)) +
  ...
  theme_minimal()
plot(p6)
figure_file <- here("starter-analysis-exercise", "results", "figures", "weight-age-scatter.png")
