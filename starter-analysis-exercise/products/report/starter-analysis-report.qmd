...
Rinu Thomas contributed to this exercise.
...
```{r}
#| label: tbl-resulttable
#| tbl-cap: "Linear Model Fit"
#| echo: FALSE
resulttable=readRDS("../../results/tables-files/resulttable3.rds")
knitr::kable(resulttable)
```
...
```{r}
#| label: fig-boxplot
#| fig-cap: "Boxplot of Height by Marital Status."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","marital-height-boxplot.png"))
```

```{r}
#| label: fig-scatter
#| fig-cap: "Scatterplot of Weight vs. Age."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","weight-age-scatter.png"))
```
